...
def generate_split_gallery_images(
    ...
    *,
    ...
    Writes ``{name_prefix}_1.png`` … ``{name_prefix}_3.png`` under *work_dir* and returns
    relative URLs ``/task-files/{task_id}/...`` for static serving.

    Raises:
        UGCServiceError: missing API key, bad model output, or API/HTTP failure after retries.
    """
